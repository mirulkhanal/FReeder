...
const STYLE_OPTIONS: Array<{
...
}> = [
  {
    id: 'highlight',
    label: 'Highlight',
    description: 'Filled background behind the text.',
  },
  {
    id: 'underline',
    label: 'Underline',
    description: 'Solid line under the selection.',
  },
  {
    id: 'squiggly',
    label: 'Squiggly',
    description: 'Shown as underline (wavy style not yet supported).',
  },
];
